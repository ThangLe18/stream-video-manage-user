...
public class VideoAudioWriter implements Runnable
{
    ...
    public VideoAudioWriter()
    {
        
    }
    public VideoAudioWriter(OutputStream mos, String mis, int maudioChannels)
    {
        os=mos;
        ...
        try {
            ...
            Logger.getLogger(VideoAudioWriter.class.getName()).log(Level.SEVERE, null, ex);
        }
