...
public class VideoWriter implements Runnable
{
    ...
    public VideoWriter()
    {
        ...
        public VideoWriter(OutputStream mos, String mis, int maudioChannels)
    {
        os=mos;
...
//        recorder.setVideoBitrate(2000000);
    ...
    public void run() 
    {
                    ...
                    exec.scheduleAtFixedRate(new Runnable() {
                        ...
                        public void run()
                        {
                            try
                            {
                                ...
                                System.out.println("audio takes after audio recorded:"+(System.currentTimeMillis()-t1));
                            } 
        ...
        while (true)
        {
            ...
            System.out.println("After video recorded:"+(System.currentTimeMillis()-t2));
        }
        try {
            cFrame.dispose();
            recorder.stop();
